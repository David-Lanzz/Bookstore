...
> 
**BOOKSTORE** is a project i worked to help clients all around the world get books from an API to read and also add and remove books of their choice.
...
>  Clone repo via cmd - https://github.com/David-Lanzz/Bookstore.git
...
- git clone https://github.com/David-Lanzz/Bookstore.git
- cd my-project
- npm i
- npm start
### Install
